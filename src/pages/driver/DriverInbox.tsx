...
import { Check, X, Phone, MapPin, Package, User, Calendar, Loader2 } from 'lucide-react';
...
export default function DriverInbox() {
  ...
  const deliveredOrders = myOrders.filter(o => o.driver_status === 'DRIVER_DELIVERED');
  const failedOrdersList = myOrders.filter(o => o.driver_status === 'DRIVER_FAILED');
    ...
    <div className="min-h-screen bg-background p-4 pb-20">
      ...
      {myOrders.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground text-sm">
            Wait for your runner to assign orders to you
          </p>
        </div>
      )}
