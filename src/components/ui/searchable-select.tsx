...
export interface SearchableSelectOption {
  label: string;
  value: string;
  searchLabel?: string; // Additional text to search on
}
...
export function SearchableSelect({
  ...
  const allOptions = React.useMemo((): SearchableSelectOption[] => {
    return [{ ...allOption, searchLabel: allOption.label }, ...options];
  }, [options, allOption]);
