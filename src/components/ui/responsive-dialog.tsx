...
export function ResponsiveDialogContent({
  ...
  return (
    <DialogContent className={cn("max-h-[90vh] overflow-hidden", className)}>
      {children}
    </DialogContent>
  );
}
...
export function ResponsiveDialogFooter({
  ...
  if (isMobile) {
    return (
      <DrawerFooter
        className={cn(
          "sticky bottom-0 bg-background border-t pt-4 pb-6 -mx-4 px-4",
          className
        )}
      >
        {children}
...
export function ResponsiveDialogBody({
  ...
  if (isMobile) {
    return (
      <ScrollArea className={cn("flex-1 overflow-auto px-4", className)}>
        {children}
      </ScrollArea>
    );
  }
  ...
  return (
    <div className={cn("overflow-auto flex-1 py-4", className)}>{children}</div>
  );
}
