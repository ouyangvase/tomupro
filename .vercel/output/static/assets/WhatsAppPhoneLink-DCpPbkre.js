import{j as n,bf as l,bg as p,bh as h}from"./index-CcYjDdHK.js";import{s as f}from"./phone-DsajZKK7.js";import{P as x}from"./phone-DnPMmi-M.js";function c(e){return f(e)}function u(e){return c(e).length>0}function g(e){return!e||e.length===0?"Product × 1 unit":e.map(t=>{var a,i;const s=((a=t.product)==null?void 0:a.sku_code)||t.sku_label||"PRODUCT",o=((i=t.product)==null?void 0:i.sku_name)||"Unknown";return`${s}/${o} × ${t.qty} unit`}).join(`
`)}function j(e){const r=e.customer_name||"Customer",t=c(e.phone),s=e.address||"Address not provided",o=e.area||"Area not specified",a=g(e.order_items),i=Number(e.total_amount||0).toFixed(0);return`Hi ${r} 👋
