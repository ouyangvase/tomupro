-- Add date range parameters to get_delivered_summary_filtered
-- Fixes mismatch between summary cards (server-side, no date filter) and
-- list count (client-side, date-filtered) on Delivered Orders page.
