-- Final Runner outcomes take precedence over stale Driver review flags.
-- This keeps Driver Operations and Driver App on the same lifecycle source.
...
COMMENT ON FUNCTION public.get_driver_assignment_source(uuid, uuid, date, date, boolean, boolean) IS
  'Canonical Driver assignment source. Final Runner outcomes override stale pending Driver review flags.';
